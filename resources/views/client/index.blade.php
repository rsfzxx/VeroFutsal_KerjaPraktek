        ...
        <div class="card-body">
          ...
          @csrf
            <div class="form-group">
              <label for="category">Pemesanan</label><br>
              <select
                ...
                required
              >
                <option value="" disabled selected>-- Jenis Pemesanan --</option>
            ...
            <div class="form-group">
              <label for="start">Jam Mulai</label><br>
              <select
                class="select2 form-control"
                id="start"
                name="start"
            ...
            <div class="form-group">
              <label for="end">Berakhir</label><br>
              <select
                class="select2 form-control"
                id="end"
                name="end"
                required
              >
                <option value="" disabled selected>-- Pilih Jam Berakhir --</option>
