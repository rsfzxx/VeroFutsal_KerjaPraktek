                    ...
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto text-right">
                          ...
                          <small class="text-muted">/Tim</small>
                          @if ($data['kursi'] < 50)
                            <p class="text-primary" style="margin: 0;"><small>{{ $data['kursi'] }} Lapangan Tersedia</small></p>
                          @endif
                        </div>
                      </div>
                    </div>
          ...
          <div class="col-12 mb-4">
              <div class="card o-hidden border-0 shadow h-100 py-2">
                <div class="card-body text-center">
                  <h3 class="text-gray-900 font-weight-bold">Lapangan Tidak Tersedia</h3>
                  <p class="text-muted">Ubah pencarian pemesanan dengan waktu yang berbeda.</p>
