            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-4">
              <a href="{{ route('pesan', ['kursi' => 'K' . $i, 'data' => Crypt::encrypt($data)]) }}">
                <div class="kursi bg-white">
                  <div class="font-weight-bold text-primary m-auto" style="font-size: 26px;">Lapangan{{ $i }}</div>
                </div>
              </a>
            </div>
          @else
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-4">
              <div class="kursi" style="background: #858796">
                <div class="font-weight-bold text-white m-auto" style="font-size: 26px;">Lapangan{{ $i }}</div>
              </div>
            </div>
          @endif
        @endfor
