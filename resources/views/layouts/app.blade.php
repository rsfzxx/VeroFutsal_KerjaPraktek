...
<head>
  ...
  <title>Vero Futsal - @yield('title')</title>
            ...
            <div class="container my-auto">
              <div class="copyright text-center my-auto">
                <span>
                  ...
                  <a href="https://github.com/rsfzxx/" target="_blank"
                    >Vero Futsal</a
                  >.
                </span>
              </div>
        ...
        <nav class="navbar navbar-expand navbar-light topbar mb-4">
          <div class="container">
            <a class="title" href="{{ url('/') }}">
              ...
              <div class="title-text mx-3">Vero Futsal</div>
            </a>
            <!-- Topbar Navbar -->
        ...
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>
              ...
              @endif
              &nbsp; All rights reserved • by
              <a href="https://github.com/rismanmuhammadhafidz/" target="_blank"
                >Vero Futsal</a
              >.
            </span>
          </div>
