...
class PemesananController extends Controller
{
    ...
    public function store(Request $request)
    {
        if ($request->category) {
            ...
            return redirect()->back()->with('success', 'Pemesanan Lapangan ' . $rute->transportasi->category->name . ' Success!');
        }
    }
    ...
    public function pesan($kursi, $data)
    {
        ...
        return redirect('/')->with('success', 'Pemesanan Lapangan ' . $rute->transportasi->category->name . ' Success!');
    }
}
